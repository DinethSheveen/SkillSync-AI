  ...
  return (
    <div className="min-h-screen flex justify-center items-center">
        <form onSubmit={loading? undefined :handleSubmit} className="sm:w-87.5 w-[90%] text-center border border-gray-300/60 rounded-2xl px-8 bg-white">
            ...
            <button type="submit" className={`mt-2 w-full h-11 rounded-full text-white bg-violet-700 hover:opacity-90 transition-opacity ${loading?"cursor-not-allowed animate-pulse":"cursor-pointer"}`}>
